...
public class AddImageActivity extends AppCompatActivity {
    ...
    private EditText editTextAddTitle, getEditTextAddDescritption;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getEditTextAddDescritption = findViewById(R.id.editTextAddDescription);
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AddImageActivity.this, "Please select an image", Toast.LENGTH_LONG);
                }
                else
                {
                    Toast.makeText(AddImageActivity.this, "entered else", Toast.LENGTH_SHORT);
                    String title = editTextAddTitle.getText().toString();
                    String description = getEditTextAddDescritption.getText().toString();
                    ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
                    Toast.makeText(AddImageActivity.this, "checkpoint 1", Toast.LENGTH_SHORT);

                    scaledImage = makeSmall(selectedImage, 300);
                    selectedImage.compress(Bitmap.CompressFormat.PNG, 10, outputStream);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable @org.jetbrains.annotations.Nullable Intent data) {
        ...
        {
            // convert the image to type bitmap
            try {
                // this is successful
    ...
    // reducing the size of the given image:
